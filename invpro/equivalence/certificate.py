...
Builds the ``invpro.lean`` layout: preamble, variant with ``sorry``, auxiliary lemmas with
proof bodies, then the original theorem with composed ``have`` / ``exact`` bridge steps.
"""

from __future__ import annotations

from invpro.utils.lean_proof_text import (
    normalize_proof_indent,
    theorem_header_through_by,
    theorem_with_sorry,
)
from invpro.equivalence.types import AuxiliaryGoalsBundle, AuxiliaryVerificationResult
