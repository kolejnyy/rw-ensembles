...
The module class is `RewritingCanonicalizationModule` (`invpro/canonicalization/rewriting.py`), and YAML is parsed through canonicalization config factories (`invpro/canonicalization/conf/*`).
