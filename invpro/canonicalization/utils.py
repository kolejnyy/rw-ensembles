...
REWRITES_IMPORT = "import invpro.lean.Rewrites"


def ensure_rewrites_import(content: str) -> str:
    """Ensure Lean content has invpro.lean.Rewrites import (for rwcnc tactic)."""
    if REWRITES_IMPORT in content or "invpro.lean.Rewrites" in content:
        return content
    if "import Mathlib\n" in content:
