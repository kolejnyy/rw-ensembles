...
from rwens.utils.metrics import diagnostics_indicate_success
from rwens.utils.text_positions import eof_line_col, offset_to_line_col
    ...
    def verify(
        ...
        *,
        ...
        diagnostics_ok
            ...
            :func:`rwens.utils.metrics.diagnostics_indicate_success`). Default:
            :func:`~rwens.utils.metrics.diagnostics_indicate_success`.
