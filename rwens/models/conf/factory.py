...
def prover_from_config(config: ProverConfig) -> FormalProver:
    ...
    from rwens.models.naive_st import NaiveStepByStepProver
    from rwens.models.canonical_st import CanonicalProver
    ...
    if config_class_name == "CanonicalLLMProver":
        from rwens.models.canonical_llm import CanonicalLLMProver
